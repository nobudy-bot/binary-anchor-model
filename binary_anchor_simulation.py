...
ax1.plot(time, A2, 'color', color='orange', label='Scenario 2: Dynamic Oscillation (r alternates)', linewidth=2)
...
ax2.plot(time, L2, 'color', color='orange', label='Scenario 2: Dynamic Oscillation', linewidth=2)
